...
#define MAX_KD_MIN	0.01			// Greater than 0 to avoid division by 0 in calculation of Kd term
  ...
  double, double, double, enum Direction);     //   Setpoint.  Initial tuning parameters are also set here
  ...
  void SetControllerDirection(enum		  // * Sets the Direction, or "Action" of the controller. DIRECT
  Direction );						      //   means the output will increase when error is positive. REVERSE										  
